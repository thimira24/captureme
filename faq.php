...
<head>
    ...
    <title id="titleCaption">FAQ | CaptureMe Online Free Screen Recorder</title>
...
<body>
    ...
    <section class="privacy-section">
        ...
        <!-- FAQ Section-->
        <h1 class="feature-title">Frequently Asked Questions</h1>
        <p class="subtitle">Everything you need to know about the CaptureMe Screen Recorder.</p>

        <!-- faqs section -->
        <?php include 'components/accordion2.html';?>

    </section>


    <!-- cta section -->
    <?php include 'components/callout.html';?>
